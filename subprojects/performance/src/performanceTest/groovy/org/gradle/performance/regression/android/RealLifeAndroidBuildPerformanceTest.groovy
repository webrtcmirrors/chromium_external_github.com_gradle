...
class RealLifeAndroidBuildPerformanceTest extends AbstractAndroidPerformanceTest {
    ...
    def "#tasks on #testProject"() {
        ...
        runner.targetVersions = ["5.2-20181211000030+0000"]
...
//        'k9AndroidBuild'    | '1g'   | false    | null       | null | 'clean k9mail:assembleDebug'
        'largeAndroidBuild' | '8g'   | true     | null       | null | 'help'
        'largeAndroidBuild' | '8g'   | true     | null       | null | 'assembleDebug'
        'largeAndroidBuild' | '8g'   | true     | 2          | 8    | 'clean phthalic:assembleDebug'
    }
}
