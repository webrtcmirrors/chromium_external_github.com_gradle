...
class CppCompilerTest extends GccCompatibleNativeCompilerTest {
    ...
    protected NativeCompiler getCompiler(CommandLineToolContext invocationContext, String objectFileExtension, boolean useCommandFile) {
        new CppCompiler(buildOperationExecutor, compilerOutputFileNamingSchemeFactory, commandLineTool, invocationContext, cppCompilerTool.getOptimizedTransformer(), objectFileExtension, useCommandFile, workerLeaseService)
    }
